...
-- ----------------------------
INSERT INTO `cms_settings` VALUES (1, 'Beta', 'Beta Hotel', 'https://projectbeta.online/', 'YJ0nPVisM0JoLMrSer7KWPP7A93CPJXl', 'Arcturus', 1, 10000, 500, 500, 'Welkom op Talpa!', 5, 5, 5, 3600, '0', 'uk2.protected.pw', '30085', '', '', 'https://swf.talpahotel.nl/', 'bibliotheek/', 'gamedata/acc_head_U_antenna.txt', 'gamedata/override/acc_head_U_happy.txt', 'gamedata/acc_head_U_excited.txt', 'gamedata/override/acc_head_U_angry.txt', 'gamedata/acc_head_U_bobba.txt', 'gamedata/furnidata.xml', 'gordon/PRODUCTION-201601012205-226667486/', '6Ld7seYUAAAAAGzDcAorJbPN0-x9GIJFw_8s85jn', 5, 'jfzNca');
...
-- ----------------------------
INSERT INTO `cms_spotlight` VALUES (1, 100, 1, 'je inzet voor Talpa wordt gezien en gewaardeerd!', 'bij ons ben je niet onopvallend gebleven, ga zo door!');
